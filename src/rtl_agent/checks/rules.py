...
class MissingClockOnContainerRule(ScriptRule):
    ...
    description = "A module with sub-instances has no clock-like port or signal detected."
...
class MissingResetOnContainerRule(ScriptRule):
    ...
    severity = "P3"
    category = "clock_reset"
    description = "A module with sub-instances has no reset-like port or signal detected."
